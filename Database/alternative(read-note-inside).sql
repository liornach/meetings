/* This option was meant for the case where you'll set up the database in some other platform than phpMyAdmin*/
-- phpMyAdmin SQL Dump
-- version 5.2.0
...
('root', '[{\"db\":\"appointments\",\"table\":\"groups\"},{\"db\":\"appointments\",\"table\":\"appointments\"},{\"db\":\"theatre\",\"table\":\"movies\"},{\"db\":\"theatre\",\"table\":\"theatres\"},{\"db\":\"gift-shop\",\"table\":\"gifts\"},{\"db\":\"gift_shop\",\"table\":\"gifts\"},{\"db\":\"steimatzky\",\"table\":\"books\"},{\"db\":\"steimatzky\",\"table\":\"genres\"},{\"db\":\"nature-sites\",\"table\":\"sites\"},{\"db\":\"nature-sites\",\"table\":\"districts\"}]');
...
('root', '2023-03-26 16:52:27', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
